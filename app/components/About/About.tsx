    ...
    <section className="about">
      ...
      <div className="flex justify-center items-center space-x-16 my-36 max-h-[300px] max-w-[1000px]">
        <div className="flex flex-col justify-between">
          ...
          <div className={`flex justify-around space-x-3.5 mt-6 ${skills === 1 ? "flex" : "hidden"}`}>
        ...
        <Image
          src="/portrait.webp"
          className="rounded-2xl shadow-card shadow-black/0 transition-all hover:shadow-black/30 duration-300"
          alt="Portrait"
          draggable="false"
          width={300}
          height={300}
